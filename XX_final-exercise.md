In this section you will combine many of the the techniques we have learned throughout the workshop.
...
- Customise your message via the config file
- Deploy your deals microservice on Kubernetes
- Call service
...
* Give your Deployments a custom name, we will all deploy to the same namespace.


----

Try first on your own, hints to follow....
...
`cd v3/`
`docker build -t goto-cph/deals:v3 .`
...
`cd v4/`
`docker build -t goto-cph/deals:v4 .`
...
`kubectl set image deployment/deals deals=goto-cph/deals:v4`
